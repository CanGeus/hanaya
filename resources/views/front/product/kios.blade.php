...
@push('meta')
    <meta name="title"
        content="Penyedia Kios Interaktif & Digital Signage Indonesia | Solusi Teknologi untuk Bisnis dan Pemasaran Modern">
    <meta name="keywords"
        content="kios interaktif, digital signage, teknologi signage, kios informasi, digital signage untuk bisnis, pemasaran digital, solusi kios, layar interaktif, layar digital, digital signage Indonesia">
    <meta name="description"
        content="Temukan solusi kios interaktif dan digital signage terbaik untuk bisnis Anda. Tawarkan pengalaman pelanggan yang lebih modern dengan layar interaktif untuk informasi, promosi, dan pemasaran digital.">
@endpush
@section('top')
            ...
            <div class="card">
                <div class="card-body">
                    <p class="text-hny-tertiary text-capitalize">
                        ...
                        Kios K & Digital Signage
                    </p>
                    <h2 class="text-dark">
                        Benefit of Digital Signage & Kios K Hanaya
                    </h2>
                    <p class="text-dark">
